...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        roleSelection.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Employee", "Admin" }));
    ...
    private void loginButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginButtonMouseClicked
        // TODO add your handling code here:
        /**
         * if role selection = Employee, check employee login details, if
         * correct open EmployeeMenu if wrong, tell user Incorrect login details
         */
        ...
        {
            /**
             * if role selection = Admin, check admin login details, if correct
             * open AdminMenu if wrong, tell user Incorrect login details
             */
